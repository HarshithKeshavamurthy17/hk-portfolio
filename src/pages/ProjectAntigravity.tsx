...
import { Atom, Globe, MousePointer, Activity, ArrowLeft, Zap, Code, CheckCircle2, TrendingUp } from 'lucide-react';

export default function ProjectAntigravity() {
    return (
        <div className="min-h-screen bg-background text-foreground pt-24 pb-16">
            {/* Background decoration */}
            <div className="pointer-events-none fixed inset-0 -z-10">
                <div className="absolute left-1/2 top-0 size-[800px] -translate-x-1/2 rounded-full bg-gradient-to-br from-purple-900/10 via-blue-900/10 to-slate-900/10 blur-3xl" aria-hidden="true" />
            </div>
            ...
            <div className="mx-auto max-w-6xl px-6 space-y-16">
                ...
                >
                    <div className="flex items-start justify-between gap-4">
                        <div className="flex-1 space-y-4">
                            ...
                            <h1 className="text-4xl md:text-5xl font-bold text-white">Antigravity</h1>
                            ...
                            <div className="pt-4 flex gap-4">
                                <a
                                    ...
                                    className="inline-flex items-center gap-2 rounded-full bg-purple-500 px-6 py-2.5 text-sm font-bold text-white hover:bg-purple-600 transition-all hover:scale-105 shadow-lg shadow-purple-500/25"
                                >
                ...
                >
                    {[
                        {
                            icon: <Atom className="size-5 text-purple-300" aria-hidden="true" />,
                        ...
                        {
                            icon: <Globe className="size-5 text-blue-300" aria-hidden="true" />,
                            title: 'VISUALIZATION',
                            value: 'Immersive 3D',
                        ...
                        {
                            icon: <MousePointer className="size-5 text-emerald-300" aria-hidden="true" />,
                            title: 'INTERACTION',
                    ...
                    >
                        <section className="space-y-4">
                            <h2 className="text-2xl font-semibold text-white flex items-center gap-2">
                                <Activity className="size-6 text-purple-400" aria-hidden="true" />
                                The Problem
                            </h2>
                            <div className="space-y-4 text-neutral-300 leading-relaxed">
                                ...
                                <blockquote className="border-l-2 border-purple-400/50 pl-4 italic text-neutral-200">
                ...
                >
                    ...
                    <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.06] to-white/[0.02] p-6 backdrop-blur-sm">
                        ...
                        <div className="space-y-3 text-neutral-300 leading-relaxed">
                            <p>
                                Antigravity is built as a cutting-edge web application leveraging <strong>React</strong> for reactive UI management and <strong>Three.js</strong> with custom <strong>WebGL shaders</strong> for high-performance 3D rendering and physics simulation.
                            </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                            ...
                            >
                                ...
                                <p className="text-2xl font-bold text-purple-300 mb-2">{outcome.value}</p>
                ...
                >
                    <p className="text-sm text-neutral-300">
                        Antigravity represents a breakthrough in <span className="font-semibold text-white">physics education and simulation technology</span>, combining cutting-edge WebGL rendering with accurate physics calculations to create an immersive, interactive platform that makes gravitational mechanics accessible and engaging for everyone.
                    </p>
                    <div className="mt-4 flex justify-center gap-4">
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-2 rounded-full bg-purple-500 px-6 py-2 text-sm font-bold text-white hover:bg-purple-600 transition-colors shadow-lg shadow-purple-500/25"
                        >
                            <Zap className="size-4" />
                            Live Demo
                        </a>
