...
export function Footer({ className }: FooterProps) {
  return (
    <footer className={cn('border-t border-border/40 bg-background/80 backdrop-blur', className)}>
      <div className="container mx-auto flex w-full max-w-full flex-col items-center justify-between gap-6 px-8 md:px-12 lg:px-16 py-10 text-base text-muted-foreground sm:flex-row">
